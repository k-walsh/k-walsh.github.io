  ...
  return (
    <PageHeader
      ...
      description={[
        ...
        <br />,
        <br />,
        "CS111 was the intro computer science course I took at Brown, and the first CS course I have ever taken, so TAing for this class for two years was one of the highlights of my time at Brown. Throughout the semester, I updated the site with new assignments and loved changing the themes of the ducks to match the seasons.",
      ]}
